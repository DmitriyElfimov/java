...
public class BookingPresenter implements ViewObserver {
    ...
    public void onChangeReservationTable(int reservationNo, Date reservationDate, int tableNo, String name){
        model.changeReservationTable(reservationNo, reservationDate, tableNo, name);
